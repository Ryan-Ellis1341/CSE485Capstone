...
export default function Dashboard({API, auth, year=2026, scenario='2026:Base'}){
  ...
  async function load(){
    ...
    const f = await fetch(`${API}/forecast/ai`, auth({method:'POST', body: JSON.stringify({year:2024, account:'Revenue:Food', model:'arima', months:12})}))
