...
import PresetWizard from './pages/PresetWizard.jsx'
...
export default function App(){
  ...
  const pages = {
    ...
    'PresetWizard': <PresetWizard api={api} token={token} year={year} scenario={scenario}/>,
    'ReportDesigner': <ReportDesigner api={api} token={token}/>,
    'SetupWizard': <SetupWizard api={api} token={token} year={year} scenario={scenario}/>,
  ...
  return (
    <div className="min-h-screen text-slate-900">
      ...
      <ChatWidget api={api} token={token} userId="student1" threadId="global" year={year} scenario={scenario} />
    </div>
  )
}