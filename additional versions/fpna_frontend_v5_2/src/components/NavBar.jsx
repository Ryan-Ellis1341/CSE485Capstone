...
const items = ['Login','SetupWizard','Dashboard','BvA','Forecast','Scenarios','Headcount','Assets','FX','Migrate','BoardPack','PresetWizard','ReportDesigner']
  ...
  return (
    <div className="sticky top-0 z-10 bg-white border-b">
      <div className="max-w-7xl mx-auto flex items-center gap-2 p-2 overflow-x-auto">
        <div className="font-semibold mr-2">FP&A v5.2</div>
        {items.map(i => (
